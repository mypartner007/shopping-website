<div class="row table-filter-container">
    <div class="col-sm-12">
        ...
        <div class="item-table-filter">
            ...
            <input name="q" class="form-control" placeholder="<?php echo trans("user_email"); ?>" type="search" value="<?php echo html_escape($this->input->get('q', true)); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
        </div>

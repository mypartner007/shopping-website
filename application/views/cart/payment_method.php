											...
											<div class="form-group">
												<ul class="payment-options-list">
													...
													<li>
														<div class="option-payment">
															<div class="custom-control custom-radio">
																<input type="radio" class="custom-control-input" id="option_wallet_credit" name="payment_option" value="wallet_credit" required <?php echo ($check_option == true) ? 'checked' : ''; ?>>
																<label class="custom-control-label label-payment-option" for="option_wallet_credit"><?php echo trans("wallet_credit"); ?></label>
															</div>
														</div>
													</li>
												</ul>
